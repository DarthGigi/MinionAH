...
<Listbox bind:value={selectedTier} class="z-50">
  ...
  <ListboxButton class="relative w-full cursor-default rounded-md bg-neutral-700 py-1.5 pl-3 pr-10 text-left text-neutral-200 shadow-sm ring-1 ring-inset focus:outline-none ring-transparent focus:ring-2 focus:ring-neutral-500 sm:text-sm sm:leading-6">{isNaN(selectedTier) || selectedTier == null ? "Select tier" : `${["I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII"][selectedTier - 1]} (${selectedTier})`}</ListboxButton>

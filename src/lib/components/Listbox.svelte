<script lang="ts">
  ...
  // filler data, array
  let data = [{ minion: "Bob" }, { minion: "Kevin" }, { minion: "Stuart" }, { minion: "Dave" }, { minion: "Jerry" }, { minion: "Tim" }, { minion: "Mark" }, { minion: "Phil" }, { minion: "Carl" }, { minion: "Tom" }, { minion: "John" }, { minion: "Mike" }, { minion: "Paul" }];

  let showDropdown = false;
</script>

<ul class="max-h-6 overflow-scroll">
  {#each data as minion}
    <li>{minion.minion}</li>
  {/each}
</ul>

<li>
  <div class="relative col-span-1 list-item divide-y divide-accent rounded-lg bg-secondary">
    <div class="flex h-full w-full items-center justify-center space-x-6 px-4">
      <div class="my-2 flex flex-col items-center rounded p-1">
        <div class="h-12 w-12 flex-shrink-0 animate-pulse overflow-hidden rounded-full bg-accent p-1"></div>
        <span class="mt-1 h-5 w-14 animate-pulse rounded bg-accent"></span>
      </div>
      <div class="my-2 flex flex-col items-center rounded p-1">
        <div class="h-12 w-12 flex-shrink-0 animate-pulse overflow-hidden rounded-full bg-accent p-1"></div>
        <span class="mt-1 h-5 w-14 animate-pulse rounded bg-accent"></span>

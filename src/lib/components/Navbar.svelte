      ...
      <div class="flex h-16 justify-between">
        ...
        <div class="flex items-center gap-4">
          <div class="hidden flex-shrink-0 md:block">
            <a href="https://minions.mrgigi.me/discord" target="_blank" rel="noopener" class="relative inline-flex flex-row items-center justify-center rounded-md border border-transparent bg-neutral-600 px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors duration-300 hover:bg-[#5865F2] focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2 focus:ring-offset-neutral-800">

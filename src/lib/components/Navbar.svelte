      ...
      <div class="flex h-16 justify-between">
        ...
        <div class="flex gap-4 items-center">
          <div class="flex-shrink-0 hidden md:block">
            <a href="https://minions.mrgigi.me/discord" class="relative inline-flex items-center rounded-md border border-transparent shadow-sm bg-neutral-600 focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2 focus:ring-offset-neutral-800 flex-row justify-center hover:bg-[#5865F2] px-4 py-2 text-sm font-medium text-white transition-colors duration-300">

  ...
  <AlertDialog.Content>
    ...
    <AlertDialog.Footer>
      ...
      <AlertDialog.Action asChild>
        <Button disabled={loading} variant="destructive" on:click={() => handleButtonClick("/api/internal/dashboard/chats/delete", "DELETE", JSON.stringify({ ids: [id] }), "Deleting the chat failed. Please try again later or contact support.", (value) => (chatDeleteDialogOpen = value))}>
          {#if loading}

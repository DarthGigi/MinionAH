  ...
  <AlertDialog.Content>
    ...
    <AlertDialog.Footer>
      ...
      <AlertDialog.Action asChild>
        <Button disabled={loading} variant="destructive" on:click={() => handleButtonClick("/api/dashboard/minions/delete", "DELETE", JSON.stringify({ id: id }), "Deleting the minion failed. Please try again later or contact support.", (value) => (minionDeleteDialogOpen = value))}>
          {#if loading}
